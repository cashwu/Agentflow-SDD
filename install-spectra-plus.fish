...
require_file "$target/.claude/skills/spectra-propose/SKILL.md" "spectra-propose skill"
require_file "$target/.claude/skills/spectra-apply/SKILL.md" "spectra-apply skill"
...
if test $dry_run -eq 1
    ...
    require_file "$target/.claude/skills/spectra-propose-plus/SKILL.md" "spectra-propose-plus skill"
    require_file "$target/.claude/skills/spectra-apply-plus/SKILL.md" "spectra-apply-plus skill"
    ...
    or fail "spectra-apply-plus 未包含中文回覆規則"
end
