...
links:
  ...
  - openspec/changes/self-heal-managed-skill-source/reviews/propose-r3.md
...
- 2026-07-14 — self-heal-managed-skill-source — spectra-propose-plus rounds 1、3 — 備份規則與備份目錄回報語意在 proposal／design／delta spec 三處說法不一。
