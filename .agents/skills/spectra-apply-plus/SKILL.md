...
metadata:
  ...
  spectraPlusVersion: 1.5.0
  spectraPlusUpdated: 2026-07-16
  spectraPlusFingerprint: 3550501177
---
<!-- Generated by scripts/spectra-plus/generate.fish — DO NOT EDIT MANUALLY -->

Implement tasks from a Spectra change.

**Input**: Optionally specify a change name (e.g., `$spectra-apply-plus add-auth`). If omitted, check if it can be inferred from conversation context. If vague or ambiguous you MUST prompt for available changes.
...
1. **Select the change**
   ...
   Always announce: "Using change: <name>" and how to override (e.g., `$spectra-apply-plus <other>`).
